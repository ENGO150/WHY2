...
unsigned char checkVersion(); //THIS FUNCTION CHECKS IF LATEST VERSION OF WHY2 IS USED
unsigned char checkKey(char *key); //CHECKS IF KEY IS VALID
unsigned char checkText(char *text); //CHECKS IF TEXT IS VALID
