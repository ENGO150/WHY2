/*
    ...
    NOTE: This is (almost) completely copied from: https://github.com/libgit2/libgit2/blob/main/examples/clone.c
...
static void print_progress(const progress_data *pd)
{
    ...
    else
    {
		printf
        (
            "net %3d%% (%4" PRIuZ " kb, %5u/%5u)  /  idx %3d%% (%5u/%5u)  /  chk %3d%% (%4" PRIuZ "/%4" PRIuZ")%s\n",
...
int cloneRepository(git_repository *repo, int argc, char **argv)
{
	progress_data pd = {{0}};
